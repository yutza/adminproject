...
<head>
    ...
    ?>
    <script src="js/butget.js"></script>
</head>
<body>
...
<div class="row">
    <div class="col-md-8 col-md-offset-1">
        <form action="update_butget.php" method="post" name="formsetembut">
            <div class="panel panel-info" style="margin-top: 5px">
                <div class="form-group">
                    ...
                    ?>
                <select id="tem" class="form-control text-center">
                    <?php
                    while ($row=mysqli_fetch_array($query)){ ?>
                        <option value="<?php echo $row["b_term"] ?>"><?php echo $row["b_term"] ?></option>
                 <?php   }
                    ?>
                </select>
                </div>
                ...
                <div class="form-group" id="edit_butget">
