            ...
            <div class="panel panel-info" style="margin-top: 5px">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        $sql="SELECT * FROM `tbl_aword_techer`";
        ...
        <div class="modal-body">
            ...
            <div class="panel panel-info" style="margin-top: 5px">
                <div class="panel-heading">
                    <h3 class="panel-title"><h3 class="text-center">เพิ่มข้อมูลผลงานสิ่งประดิษฐ์ นวัตกรรม งานสร้างสรรค์ หรืองานวิจัยของครู</h3></h3>
                </div>
